...
import org.infinispan.offheap.container.versioning.OffHeapNumericVersion;
...
public class OffHeapNumericVersionGenerator implements VersionGenerator {
   ...
   private static final Log log = LogFactory.getLog(org.infinispan.offheap.container.versioning.OffHeapNumericVersionGenerator.class);
   ...
   public org.infinispan.offheap.container.versioning.OffHeapNumericVersionGenerator clustered(boolean clustered) {
   ...
   public class RankCalculator {
      ...
      public void calculateRank(ViewChangedEvent e) {
         long rank = org.infinispan.offheap.container.versioning.OffHeapNumericVersionGenerator.this
