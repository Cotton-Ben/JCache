...
import org.infinispan.offheap.container.entries.OffHeapReadCommittedEntry;
...
/**
 * An extension of {@link org.infinispan.offheap.container.entries.OffHeapReadCommittedEntry} that provides Repeatable Read semantics
 *
...
public abstract class OffHeapRepeatableReadEntry extends OffHeapReadCommittedEntry {
   private static final Log log = LogFactory.getLog(org.infinispan.offheap.container.entries.OffHeapRepeatableReadEntry.class);
