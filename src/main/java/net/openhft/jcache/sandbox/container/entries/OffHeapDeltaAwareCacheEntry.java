...
import static org.infinispan.offheap.container.entries.OffHeapDeltaAwareCacheEntry.Flags.*;
...
public class OffHeapDeltaAwareCacheEntry implements CacheEntry, StateChangingEntry {
   private static final Log log = LogFactory.getLog(org.infinispan.offheap.container.entries.OffHeapDeltaAwareCacheEntry.class);
   ...
   public boolean skipLookup() {
      return isFlagSet(org.infinispan.offheap.container.entries.OffHeapDeltaAwareCacheEntry.Flags.SKIP_LOOKUP);
   }
   ...
   public boolean isLoaded() {
      return isFlagSet(org.infinispan.offheap.container.entries.OffHeapDeltaAwareCacheEntry.Flags.LOADED);
   }

   @Override
   public void setLoaded(boolean loaded) {
      setFlag(loaded, org.infinispan.offheap.container.entries.OffHeapDeltaAwareCacheEntry.Flags.LOADED);
   }

   @Override
   public void setSkipLookup(boolean skipLookup) {
      setFlag(skipLookup, org.infinispan.offheap.container.entries.OffHeapDeltaAwareCacheEntry.Flags.SKIP_LOOKUP);
   }
