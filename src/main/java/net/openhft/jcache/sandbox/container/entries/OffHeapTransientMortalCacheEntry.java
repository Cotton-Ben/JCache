...
import org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheValue;
...
public class OffHeapTransientMortalCacheEntry extends OffHeapAbstractInternalCacheEntry {
   ...
   public boolean equals(Object o) {
      ...
      org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheEntry that = (org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheEntry) o;
   ...
   @Override
   public org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheEntry clone() {
      return (org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheEntry) super.clone();
   }
   ...
   public static class Externalizer extends AbstractExternalizer<org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheEntry> {
      @Override
      public void writeObject(ObjectOutput output, org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheEntry entry) throws IOException {
      ...
      @Override
      public org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheEntry readObject(ObjectInput input) throws IOException, ClassNotFoundException {
         ...
         return new org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheEntry(k, v, maxIdle, lifespan, lastUsed, created);
      }
      ...
      @Override
      public Set<Class<? extends org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheEntry>> getTypeClasses() {
         return Util.<Class<? extends org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheEntry>>asSet(org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheEntry.class);
      }
   }
}
