...
import org.infinispan.offheap.container.entries.OffHeapMortalCacheValue;
...
/**
 * A transient, mortal cache value to correspond with {@link org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheEntry}
 *
...
public class OffHeapTransientMortalCacheValue extends OffHeapMortalCacheValue {
   ...
   */
   ...
   public boolean equals(Object o) {
      ...
      org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheValue that = (org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheValue) o;
   ...
   @Override
   public org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheValue clone() {
      return (org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheValue) super.clone();
   }

   public static class Externalizer extends AbstractExternalizer<org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheValue> {
      @Override
      public void writeObject(ObjectOutput output, org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheValue value) throws IOException {
      ...
      @Override
      public org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheValue readObject(ObjectInput input) throws IOException, ClassNotFoundException {
         Object v = input.readObject();
         long created = UnsignedNumeric.readUnsignedLong(input);
         Long lifespan = input.readLong();
         long lastUsed = UnsignedNumeric.readUnsignedLong(input);
         Long maxIdle = input.readLong();
         return new org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheValue(v, created, lifespan, maxIdle, lastUsed);
      }
      ...
      @Override
      public Set<Class<? extends org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheValue>> getTypeClasses() {
         return OffHeapUtil.<Class<? extends org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheValue>>asSet(org.infinispan.offheap.container.entries.OffHeapTransientMortalCacheValue.class);
      }
   }
}
