...
import static org.infinispan.offheap.container.entries.OffHeapReadCommittedEntry.Flags.*;
...
public abstract class OffHeapReadCommittedEntry implements MVCCEntry {
   private static final Log log = LogFactory.getLog(org.infinispan.offheap.container.entries.OffHeapReadCommittedEntry.class);
   ...
   public boolean isLoaded() {
      return isFlagSet(org.infinispan.offheap.container.entries.OffHeapReadCommittedEntry.Flags.LOADED);
   }

   @Override
   public void setLoaded(boolean loaded) {
      setFlag(loaded, org.infinispan.offheap.container.entries.OffHeapReadCommittedEntry.Flags.LOADED);
   }
