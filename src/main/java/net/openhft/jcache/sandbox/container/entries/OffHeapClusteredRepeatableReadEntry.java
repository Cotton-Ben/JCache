...
import org.infinispan.offheap.container.entries.OffHeapRepeatableReadEntry;
...
public class OffHeapClusteredRepeatableReadEntry extends OffHeapRepeatableReadEntry implements Versioned {
   ...
   private static final Log log = LogFactory.getLog(org.infinispan.offheap.container.entries.OffHeapClusteredRepeatableReadEntry.class);
