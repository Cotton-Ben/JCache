...
public class OffHeapMortalCacheEntry
   ...
   public boolean equals(Object o) {
     ...
     org.infinispan.offheap.container.entries.OffHeapMortalCacheEntry that = (org.infinispan.offheap.container.entries.OffHeapMortalCacheEntry) o;
   ...
   @Override
   public org.infinispan.offheap.container.entries.OffHeapMortalCacheEntry clone() {
      return (org.infinispan.offheap.container.entries.OffHeapMortalCacheEntry) super.clone();
   }
    ...
    public static class Externalizer extends AbstractExternalizer<org.infinispan.offheap.container.entries.OffHeapMortalCacheEntry> {
      @Override
      public void writeObject(ObjectOutput output, org.infinispan.offheap.container.entries.OffHeapMortalCacheEntry mce) throws IOException {
      ...
      @Override
      public org.infinispan.offheap.container.entries.OffHeapMortalCacheEntry readObject(ObjectInput input) throws IOException, ClassNotFoundException {
         Object k = input.readObject();
         Object v = input.readObject();
         long created = UnsignedNumeric.readUnsignedLong(input);
         Long lifespan = input.readLong();
         return new org.infinispan.offheap.container.entries.OffHeapMortalCacheEntry(k, v, lifespan, created);
      }
      ...
      @Override
      public Set<Class<? extends org.infinispan.offheap.container.entries.OffHeapMortalCacheEntry>> getTypeClasses() {
         return Util.<Class<? extends org.infinispan.offheap.container.entries.OffHeapMortalCacheEntry>>asSet(org.infinispan.offheap.container.entries.OffHeapMortalCacheEntry.class);
      }
   }
