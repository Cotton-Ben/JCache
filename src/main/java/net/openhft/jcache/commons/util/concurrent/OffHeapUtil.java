package net.openhft.jcache.commons.util.concurrent;
...
public final class OffHeapUtil {
   ...
   private static final Log log = LogFactory.getLog(org.infinispan.offheap.commons.util.concurrent.OffHeapUtil.class);
   ...
   public static ClassLoader[] getClassLoaders(ClassLoader appClassLoader) {
      return new ClassLoader[] {
            ...
            org.infinispan.offheap.commons.util.concurrent.OffHeapUtil.class.getClassLoader(), // Infinispan classes (not always on TCCL [modular env])
