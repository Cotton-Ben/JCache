package net.openhft.jcache.cachelistener;
...
public final class OffHeapCacheNotifierImpl extends AbstractListenerImpl implements ClusterCacheNotifier {
   ...
   private static final Log log = LogFactory.getLog(org.infinispan.offheap.notifications.cachelistener.OffHeapCacheNotifierImpl.class);
